...
# Pimp my prompt
LPROMPT() {
PS1="%{$fg_bold[white]%}┌─%{$reset_color%}[%{$fg_bold[cyan]%}%n%{$reset_color%}\
%{$fg_bold[blue]%}@%{$reset_color%}%{$fg_bold[cyan]%}%m%{$reset_color%}\
...
local func_dir="${ZDOTDIR}/functions/not_included"

_functionLoadR ${func_dir/\/not_included/}
#_functionLoadR ${func_dir}
